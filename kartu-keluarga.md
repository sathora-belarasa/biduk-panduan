...
1. Pastikan *user* berhasil masuk ke dalam BIDUK dan melihat *homepage* sebelum melakukan Apa-yang-ingin-Saya-lakukan.
...
4. Tekan tombol Cari.
5. Pilih salah satu KK BIDUK pada hasil pencarian.
6. Pada Detail Kartu Keluarga, tekan tombol Ubah (di bawah kolom Status Rumah).
...
- User Manual BIDUK v1.26.0 3.4.1.1 (Form Kartu Keluarga)
- User Manual BIDUK v1.26.0 3.4.2.1 (Mutasi Keluarga)
- User Manual BIDUK v1.26.0 3.5.1 (Pencarian Data KK)
