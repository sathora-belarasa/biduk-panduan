...
3. Tambah kriteria untuk mempersempit pencarian lebih spesifik. Contoh cari Anggota KK BIDUK dengan nama yang mengandung spesifik nama atau sebagian NIK.
...
3. Calon anggota KK BIDUK mengisi blangko dan melampirkan fotokopi KTP, surat baptis (jika sudah dibaptis).
4. Masuk menu Pencarian.
5. Pilih menu Data Kartu Keluarga.
6. Tambah kriteria pencarian Kode KK yang KK BIDUK-nya akan ditambah anggota.
7. Tekan tombol Cari yang akan menampilkan hasil pencarian.
8. Lihat detail KK BIDUK dengan menekan pada baris data yang sesuai.
...
4. Tambah kriteria untuk mempersempit pencarian spesifik Kode KK yang diberikan umat pemohon.
5. Tekan tombol Cari yang akan menampilkan hasil pencarian yang memenuhi kriteria pencarian.
6. Lihat detail KK BIDUK dengan tekan baris data KK BIDUK sesuai.
7. Masuk ke detail Anggota KK BIDUK dengan tekan baris data anggota yang ingin diperbarui.
8. Pengurus lingkungan memperbarui data sesuai info umat pemohon.
...
5. Tekan tombol Cari yang akan menampilkan hasil pencarian yang memenuhi kriteria pencarian.
6. Lihat detail KK BIDUK dengan tekan baris data KK BIDUK sesuai.
7. Centang minimal satu anggota KK BIDUK yang hendak diperbarui agamanya ke agama baru yang sama.
8. Pilih jenis mutasi: Mutasi Agama.
...
5. Tekan tombol Cari yang akan menampilkan hasil pencarian yang memenuhi kriteria pencarian.
6. Lihat detail KK BIDUK dengan tekan baris data KK BIDUK sesuai.
7. Centang anggota KK BIDUK yang hendak diperbarui status almarhumnya.
8. Jika diperlukan, isi kolom Keterangan Mutasi.
...
12. (21/03/2022) Jika KK BIDUK dengan semua anggota berstatus almarhum, lanjut mutasikan KK BIDUK dengan jenis mutasi keuskupan (keputusan KAJ).
...
1. Masuk menu Pencarian.
2. Pilih menu Data Umat.
3. Tambah kriteria untuk mempersempit pencarian spesifik nama individu umat yang datanya ingin dicetak.
4. Tekan tombol Cari.
5. Masuk ke detail Anggota KK BIDUK dengan tekan baris data yang ingin dicetak.
...
1. Masuk menu Pencarian.
2. Pilih menu Data Umat.
3. Tambah kriteria untuk mempersempit pencarian spesifik nama individu umat yang datanya ingin dilihat.
4. Tekan tombol Cari.
...
4. Tekan tombol Cari.
5. Masuk ke detail Anggota KK BIDUK dengan tekan baris data yang ingin ditambahkan/diperbarui data orang tuanya.
6. Tekan menu samping Orang Tua.
...
4. Tekan tombol Cari.
5. Masuk ke detail Anggota KK BIDUK dengan tekan baris data yang ingin dilihat riwayatnya.
6. Tekan menu samping Bidang Kepengurusan.
...
5. Pilih menu Data Kartu Keluarga.
6. Tambah kriteria untuk mempersempit pencarian spesifik Kode KK yang anggotanya hendak dimutasi.
7. Tekan tombol Cari.
8. Pilih salah satu KK BIDUK pada hasil pencarian.
9. Pada detail KK BIDUK, pilih minimal satu anggota keluarga yang hendak dimutasi ke tujuan sama.
10. Pilih jenis mutasi: Mutasi KK.
11. Jika diperlukan, isi kolom Keterangan Mutasi.
12. Pilih tujuan anggota KK BIDUK yang ingin memisahkan diri: 
...
11. Jika diperlukan, isi kolom Keterangan Mutasi.
12. Untuk memastikan, pengurus lingkungan bisa cek ke menu Pencarian > Data Mutasi Umat.
...
- User Manual BIDUK v1.26.0 3.4.1.1.1 (Cari Kartu Keluarga)
